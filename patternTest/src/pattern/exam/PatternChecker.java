...
public class PatternChecker {
   ...
   //** 한글로만 구성되었는지에 대한 형식 검사 *//*
    ...
    public static boolean isKorNum(String str) {
    	return Pattern.matches("[가-힣0-9 ]+", str);
    }
...
//    }
    ...
    public static void main(String[] args){
    	...
    	System.out.println("***********Emailtest테스트*************");
    	System.out.println(isEmail("heaves@hanmail.net"));
    	System.out.println(isEmail("heaveshanmail.net"));
