package mapred.exam.multiple.air;
...
public class AirMultipleDriver extends Configured implements Tool {
	...
	public int run(String[] optionlist) throws Exception {
		//run메소드는 사용자가 입력한 모든 옵션에 대한 정보를 String[]로 전달 받는다.
		//-D를 입력하고 설정한 옵션과 사용자가 입력한 명령행매개변수를 분리하여 관리해야 한다.
		//getRemainArgs()를 이용하여 공통옵션(-D와 입력한 값 이외의 값)과
		...
		MultipleOutputs.addNamedOutput(job, 
				"Arrival", TextOutputFormat.class, Text.class, IntWritable.class);
		MultipleOutputs.addNamedOutput(job, 
				"Departure", TextOutputFormat.class, Text.class, IntWritable.class);
		MultipleOutputs.addNamedOutput(job, 
				"Normal1", TextOutputFormat.class, Text.class, IntWritable.class);
		MultipleOutputs.addNamedOutput(job, 
				"Normal2", TextOutputFormat.class, Text.class, IntWritable.class);
